...
{#if time}
    <svg fill="currentColor" class="time-img" height="50px" width="50px" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 490 490">
        <g>
            <g>
...
{:else}
    <h1 class="time-text">Times up!</h1>
{/if}
