import {
  ...
  tn,
  v
} from "./chunk-62O6UMB5.js";
import {
  j
} from "./chunk-A5X3OS62.js";
import {
  __publicField
} from "./chunk-2B2CG5KL.js";

// node_modules/@dotlottie/player-component/dist/chunk-6BVPVBJE.mjs
var N = window;
var O = N.ShadowRoot && (N.ShadyCSS === void 0 || N.ShadyCSS.nativeShadow) && "adoptedStyleSheets" in Document.prototype && "replace" in CSSStyleSheet.prototype;
var M = Symbol();
...
var et = (r2) => new k(typeof r2 == "string" ? r2 : r2 + "", void 0, M);
var j2 = (r2, ...t) => {
  let e = r2.length === 1 ? r2[0] : t.reduce((o, i, n) => o + ((s) => {
...
var L = (r2, t) => {
  O ? r2.adoptedStyleSheets = t.map((e) => e instanceof CSSStyleSheet ? e : e.styleSheet) : t.forEach((e) => {
    let o = document.createElement("style"), i = N.litNonce;
    i !== void 0 && o.setAttribute("nonce", i), o.textContent = e.cssText, r2.appendChild(o);
  });
};
var R = O ? (r2) => r2 : (r2) => r2 instanceof CSSStyleSheet ? ((t) => {
  let e = "";
...
f[V] = true, f.elementProperties = /* @__PURE__ */ new Map(), f.elementStyles = [], f.shadowRootOptions = { mode: "open" }, it == null ? void 0 : it({ ReactiveElement: f }), ((B = T.reactiveElementVersions) !== null && B !== void 0 ? B : T.reactiveElementVersions = []).push("1.6.3");
var K;
var z = window;
var A = z.trustedTypes;
var st = A ? A.createPolicy("lit-html", { createHTML: (r2) => r2 }) : void 0;
var q = "$lit$";
var g = `lit$${(Math.random() + "").slice(9)}$`;
var dt = "?" + g;
var yt = `<${dt}>`;
var m = document;
var U = () => m.createComment("");
var P = (r2) => r2 === null || typeof r2 != "object" && typeof r2 != "function";
var ut = Array.isArray;
var _t = (r2) => ut(r2) || typeof (r2 == null ? void 0 : r2[Symbol.iterator]) == "function";
var W = `[ 	
\f\r]`;
...
var ft = (r2) => (t, ...e) => ({ _$litType$: r2, strings: t, values: e });
var Ut = ft(1);
...
var At = (r2, t) => {
  let e = r2.length - 1, o = [], i, n = t === 2 ? "<svg>" : "", s = C;
  for (let h = 0; h < e; h++) {
    let l2 = r2[h], a, c, p = -1, u2 = 0;
    for (; u2 < l2.length && (s.lastIndex = u2, c = s.exec(l2), c !== null); )
      u2 = s.lastIndex, s === C ? c[1] === "!--" ? s = nt : c[1] !== void 0 ? s = lt : c[2] !== void 0 ? (vt.test(c[2]) && (i = RegExp("</" + c[2], "g")), s = b) : c[3] !== void 0 && (s = b) : s === b ? c[0] === ">" ? (s = i ?? C, p = -1) : c[1] === void 0 ? p = -2 : (p = s.lastIndex - c[2].length, a = c[1], s = c[3] === void 0 ? b : c[3] === '"' ? ht : at) : s === ht || s === at ? s = b : s === nt || s === lt ? s = C : (s = b, i = void 0);
    let v2 = s === b && r2[h + 1].startsWith("/>") ? " " : "";
    n += s === C ? l2 + yt : p >= 0 ? (o.push(a), l2.slice(0, p) + q + l2.slice(p) + g + v2) : l2 + g + (p === -2 ? (o.push(void 0), h) : v2);
  }
  return [gt(r2, n + (r2[e] || "<?>") + (t === 2 ? "</svg>" : "")), o];
};
var y = class {
  constructor({ strings: t, _$litType$: e }, o) {
    let i;
    this.parts = [];
    let n = 0, s = 0, h = t.length - 1, l2 = this.parts, [a, c] = At(t, e);
    if (this.el = y.createElement(a, o), $.currentNode = this.el.content, e === 2) {
      let p = this.el.content, u2 = p.firstChild;
      u2.remove(), p.append(...u2.childNodes);
    }
    for (; (i = $.nextNode()) !== null && l2.length < h; ) {
      if (i.nodeType === 1) {
        if (i.hasAttributes()) {
          let p = [];
          for (let u2 of i.getAttributeNames())
            if (u2.endsWith(q) || u2.startsWith(g)) {
              let v2 = c[s++];
              if (p.push(u2), v2 !== void 0) {
                let mt = i.getAttribute(v2.toLowerCase() + q).split(g), H = /([.?@])?(.*)/.exec(v2);
                l2.push({ type: 1, index: n, name: H[2], strings: mt, ctor: H[1] === "." ? F : H[1] === "?" ? Z : H[1] === "@" ? G : S });
              } else
                l2.push({ type: 6, index: n });
            }
          for (let u2 of p)
            i.removeAttribute(u2);
        }
        if (vt.test(i.tagName)) {
          let p = i.textContent.split(g), u2 = p.length - 1;
          if (u2 > 0) {
            i.textContent = A ? A.emptyScript : "";
            for (let v2 = 0; v2 < u2; v2++)
              i.append(p[v2], U()), $.nextNode(), l2.push({ type: 2, index: ++n });
            i.append(p[u2], U());
          }
        }
      } else if (i.nodeType === 8)
        if (i.data === dt)
          l2.push({ type: 2, index: n });
        else {
          let p = -1;
          for (; (p = i.data.indexOf(g, p + 1)) !== -1; )
            l2.push({ type: 7, index: n }), p += g.length - 1;
        }
      n++;
    }
  }
...
function w(r2, t, e = r2, o) {
  var i, n, s, h;
  if (t === x)
    return t;
  let l2 = o !== void 0 ? (i = e._$Co) === null || i === void 0 ? void 0 : i[o] : e._$Cl, a = P(t) ? void 0 : t._$litDirective$;
  return (l2 == null ? void 0 : l2.constructor) !== a && ((n = l2 == null ? void 0 : l2._$AO) === null || n === void 0 || n.call(l2, false), a === void 0 ? l2 = void 0 : (l2 = new a(r2), l2._$AT(r2, e, o)), o !== void 0 ? ((s = (h = e)._$Co) !== null && s !== void 0 ? s : h._$Co = [])[o] = l2 : e._$Cl = l2), l2 !== void 0 && (t = w(r2, l2._$AS(r2, t.values), l2, o)), t;
}
var J = class {
  constructor(t, e) {
  ...
  u(t) {
    ...
    $.currentNode = n;
    let s = $.nextNode(), h = 0, l2 = 0, a = i[0];
    for (; a !== void 0; ) {
      if (h === a.index) {
        let c;
        a.type === 2 ? c = new _(s, s.nextSibling, this, t) : a.type === 1 ? c = new a.ctor(s, a.name, a.strings, this, t) : a.type === 6 && (c = new Q(s, this, t)), this._$AV.push(c), a = i[++l2];
      }
...
var _ = class {
  ...
  T(t) {
    ...
    for (let n of t)
      i === e.length ? e.push(o = new _(this.k(U()), this.k(U()), this, this.options)) : o = e[i], o._$AI(n), i++;
...
var S = class {
  ...
  _$AI(t, e = this, o, i) {
    ...
    if (n === void 0)
      t = w(this, t, e, 0), s = !P(t) || t !== this._$AH && t !== x, s && (this._$AH = t);
    else {
      let h = t, l2, a;
      for (t = n[0], l2 = 0; l2 < n.length - 1; l2++)
        a = w(this, h[o + l2], e, l2), a === x && (a = this._$AH[l2]), s || (s = !P(a) || a !== this._$AH[l2]), a === d ? t = d : t !== d && (t += (a ?? "") + n[l2 + 1]), this._$AH[l2] = a;
    }
    s && !i && this.j(t);
  }
  j(t) {
...
var G = class extends S {
  ...
  _$AI(t, e = this) {
    var o;
    if ((t = (o = w(this, t, e, 0)) !== null && o !== void 0 ? o : d) === x)
      return;
...
pt == null ? void 0 : pt(y, _), ((K = z.litHtmlVersions) !== null && K !== void 0 ? K : z.litHtmlVersions = []).push("2.8.0");
var bt = (r2, t, e) => {
  var o, i;
...
E.finalized = true, E._$litElement$ = true, (X = globalThis.litElementHydrateSupport) === null || X === void 0 || X.call(globalThis, { LitElement: E });
var $t = globalThis.litElementPolyfillSupport;
$t == null ? void 0 : $t({ LitElement: E });
...
var I3 = (s, t) => t.kind === "method" && t.descriptor && !("value" in t.descriptor) ? { ...t, finisher(e) {
...
function l(s) {
  return (t, e) => e !== void 0 ? T2(s, t, e) : I3(s, t);
}
function L2(s) {
  return l({ ...s, state: true });
}
var u = ({ finisher: s, descriptor: t }) => (e, i) => {
  var o;
  if (i === void 0) {
    let d2 = (o = e.originalKey) !== null && o !== void 0 ? o : e.key, m2 = t != null ? { kind: "method", placement: "prototype", key: d2, descriptor: t(e.key) } : { ...e, key: d2 };
    return s != null && (m2.finisher = function(O2) {
      s(O2, d2);
    }), m2;
  }
  {
    let d2 = e.constructor;
    t !== void 0 && Object.defineProperty(e, i, t(i)), s == null ? void 0 : s(d2, i);
  }
};
function w2(s, t) {
  return u({ descriptor: (e) => {
    let i = { get() {
      var o, d2;
      return (d2 = (o = this.renderRoot) === null || o === void 0 ? void 0 : o.querySelector(s)) !== null && d2 !== void 0 ? d2 : null;
    }, enumerable: true, configurable: true };
    if (t) {
      let o = typeof e == "symbol" ? Symbol() : "__" + e;
      i.get = function() {
        var d2, m2;
        return this[o] === void 0 && (this[o] = (m2 = (d2 = this.renderRoot) === null || d2 === void 0 ? void 0 : d2.querySelector(s)) !== null && m2 !== void 0 ? m2 : null), this[o];
      };
    }
    return i;
  } });
...
var g2;
((g2 = window.HTMLSlotElement) === null || g2 === void 0 ? void 0 : g2.prototype.assignedElements) != null ? (s, t) => s.assignedElements(t) : (s, t) => s.assignedNodes(t).filter((e) => e.nodeType === Node.ELEMENT_NODE);
var P2 = { name: "@dotlottie/player-component", version: "2.7.0", description: "dotLottie animation player web component.", repository: "https://github.com/dotlottie/player-component.git", homepage: "https://dotlottie.com/players", bugs: "https://github.com/dotlottie/player-component/issues", author: "Jawish Hameed <jawish@lottiefiles.com>", license: "MIT", main: "dist/dotlottie-player.js", module: "dist/dotlottie-player.mjs", types: "dist/dotlottie-player.d.ts", files: ["dist"], keywords: ["dotlottie", "animation", "web component", "component", "lit-element", "player"], scripts: { build: "tsup", "cypress:open": "cypress open --component", dev: "tsup --watch", lint: "eslint .", "lint:fix": "eslint --fix", test: "cypress run --component", "type-check": "tsc --noEmit" }, dependencies: { lit: "^2.7.5" }, devDependencies: { "@dotlottie/common": "workspace:^", "@vitejs/plugin-legacy": "^4.1.0", "axe-core": "^4.7.2", cypress: "^12.11.0", "cypress-axe": "^1.4.0", "cypress-ct-lit": "^0.3.2", "lottie-web": "^5.12.2", terser: "^5.19.0", tsup: "^6.1.3", typescript: "^4.7.4", vite: "^4.3.9" }, publishConfig: { access: "public" }, browserslist: ["> 3%"] };
var k2 = "dotlottie-player";
var r = class extends E {
  constructor() {
    super(...arguments);
    __publicField(this, "defaultTheme", "");
    __publicField(this, "container");
    __publicField(this, "playMode", tn.Normal);
  ...
  _handleSeekChange(t) {
    ...
    try {
      ...
      throw v("Error while seeking animation");
    }
  }
  _initListeners() {
    ...
    this._unsubscribeListeners = t.state.subscribe((e$1, i) => {
      this._seeker = e$1.seeker, this.requestUpdate(), i.currentState !== e$1.currentState && this.dispatchEvent(new CustomEvent(e$1.currentState)), this.dispatchEvent(new CustomEvent(Qi.Frame, { detail: { frame: e$1.frame, seeker: e$1.seeker } })), this.dispatchEvent(new CustomEvent(Qi.VisibilityChange, { detail: { visibilityPercentage: e$1.visibilityPercentage } }));
    }), t.addEventListener("complete", () => {
      this.dispatchEvent(new CustomEvent(Qi.Complete));
    }), t.addEventListener("loopComplete", () => {
      this.dispatchEvent(new CustomEvent(Qi.LoopComplete));
      ...
      })), this.dispatchEvent(new CustomEvent(Qi.Ready));
    }), t.addEventListener("data_ready", () => {
      this.dispatchEvent(new CustomEvent(Qi.DataReady));
    }), t.addEventListener("data_failed", () => {
      this.dispatchEvent(new CustomEvent(Qi.DataFail));
    }), window && window.addEventListener("click", (e) => this._clickOutListener(e));
  }
  async load(t, e, i) {
    if (!this.shadowRoot)
      return;
    this._dotLottieCommonPlayer && this._dotLottieCommonPlayer.destroy(), this._dotLottieCommonPlayer = new bn(t, this.container, { rendererSettings: e ?? { scaleMode: "noScale", clearCanvas: true, progressiveLoad: true, hideOnTransparent: true }, hover: this.hasAttribute("hover") ? this.hover : void 0, renderer: this.hasAttribute("renderer") ? this._renderer : void 0, loop: this.hasAttribute("loop") ? this._loop : void 0, direction: this.hasAttribute("direction") ? this.direction === 1 ? 1 : -1 : void 0, speed: this.hasAttribute("speed") ? this.speed : void 0, intermission: this.hasAttribute("intermission") ? Number(this.intermission) : void 0, playMode: this.hasAttribute("playMode") ? this.playMode : void 0, autoplay: this.hasAttribute("autoplay") ? this.autoplay : void 0, activeAnimationId: this.hasAttribute("activeAnimationId") ? this.activeAnimationId : void 0, defaultTheme: this.hasAttribute("defaultTheme") ? this.defaultTheme : void 0, light: this.light, worker: this.worker, activeStateId: this.hasAttribute("activeStateId") ? this.activeStateId : void 0 }), await this._dotLottieCommonPlayer.load(i);
    let o = this.getManifest();
    this._hasMultipleAnimations = this.animationCount() > 1, o && (o.themes && (this._themesForCurrentAnimation = o.themes.filter((d2) => d2.animations.includes(this.getCurrentAnimationId() || "")), this._hasMultipleThemes = o.themes.length > 0), o.states && (this._hasMultipleStates = o.states.length > 0, this._statesForCurrentAnimation = [], o.states.forEach((d2) => {
      this._statesForCurrentAnimation.push(d2);
    }))), this._initListeners();
  }
  getCurrentAnimationId() {
    var _a;
    return (_a = this._dotLottieCommonPlayer) == null ? void 0 : _a.currentAnimationId;
  }
  animationCount() {
    var _a;
    return this._dotLottieCommonPlayer && ((_a = this._dotLottieCommonPlayer.getManifest()) == null ? void 0 : _a.animations.length) || 0;
  }
  animations() {
    var _a;
    return this._dotLottieCommonPlayer ? ((_a = this._dotLottieCommonPlayer.getManifest()) == null ? void 0 : _a.animations.map((e) => e.id)) || [] : [];
  }
  currentAnimation() {
  ...
  getState() {
    return this._dotLottieCommonPlayer ? this._dotLottieCommonPlayer.getState() : en;
  }
  getManifest() {
    var _a;
    return (_a = this._dotLottieCommonPlayer) == null ? void 0 : _a.getManifest();
  }
  getLottie() {
    var _a;
    return (_a = this._dotLottieCommonPlayer) == null ? void 0 : _a.getAnimationInstance();
  }
  getVersions() {
    return { lottieWebVersion: bn.getLottieWebVersion(), dotLottiePlayerVersion: `${P2.version}` };
  }
  previous(t) {
    var _a;
    (_a = this._dotLottieCommonPlayer) == null ? void 0 : _a.previous(t);
  }
  next(t) {
    var _a;
    (_a = this._dotLottieCommonPlayer) == null ? void 0 : _a.next(t);
  }
  reset() {
    var _a;
    (_a = this._dotLottieCommonPlayer) == null ? void 0 : _a.reset();
  }
  play(t, e) {
  ...
  setTheme(t) {
    var _a;
    (_a = this._dotLottieCommonPlayer) == null ? void 0 : _a.setDefaultTheme(t);
  }
  themes() {
    var _a, _b;
    return this._dotLottieCommonPlayer ? ((_b = (_a = this._dotLottieCommonPlayer.getManifest()) == null ? void 0 : _a.themes) == null ? void 0 : _b.map((e) => e.id)) || [] : [];
  }
  getDefaultTheme() {
  ...
  revertToManifestValues(t) {
    var _a;
    (_a = this._dotLottieCommonPlayer) == null ? void 0 : _a.revertToManifestValues(t);
  }
  static get styles() {
    return Kt;
  }
  async firstUpdated() {
    var _a;
    this.container = (_a = this.shadowRoot) == null ? void 0 : _a.querySelector("#animation"), "IntersectionObserver" in window && (this._io = new IntersectionObserver((t) => {
      var _a2, _b;
      t[0] !== void 0 && t[0].isIntersecting ? ((_a2 = this._dotLottieCommonPlayer) == null ? void 0 : _a2.currentState) === Zi.Frozen && this.play() : ((_b = this._dotLottieCommonPlayer) == null ? void 0 : _b.currentState) === Zi.Playing && this._freeze();
  ...
  disconnectedCallback() {
    var _a, _b;
    this._io && (this._io.disconnect(), this._io = void 0), (_a = this._dotLottieCommonPlayer) == null ? void 0 : _a.destroy(), (_b = this._unsubscribeListeners) == null ? void 0 : _b.call(this), window && window.removeEventListener("click", (t) => this._clickOutListener(t));
  }
  _clickOutListener(t) {
  ...
  renderControls() {
    var _a, _b, _c, _d, _e;
    let t = ((_a = this._dotLottieCommonPlayer) == null ? void 0 : _a.currentState) === Zi.Playing, e = ((_b = this._dotLottieCommonPlayer) == null ? void 0 : _b.currentState) === Zi.Paused;
    return Ut`
      ...
      this.togglePlay();
        ...
        <input
          ...
          class="seeker ${((_c = this._dotLottieCommonPlayer) == null ? void 0 : _c.direction) === -1 ? "to-left" : ""}"
          type="range"
          min="0"
          step="1"
          max="100"
      ...
      this._freeze();
          ...
          @mouseup=${() => {
      var _a2;
      (_a2 = this._dotLottieCommonPlayer) == null ? void 0 : _a2.unfreeze();
    }}
          aria-valuemin="1"
          aria-valuemax="100"
          role="slider"
        ...
        <button
          ...
          class=${((_d = this._dotLottieCommonPlayer) == null ? void 0 : _d.loop) ? "active btn-spacing-left" : "btn-spacing-left"}
      ...
      this._styleTabIsOpen = !this._styleTabIsOpen, this.requestUpdate();
                      ...
                      >
                        ...
                        ${((_e = this._dotLottieCommonPlayer) == null ? void 0 : _e.defaultTheme) === "" ? Ut`` : Ut`
                              <button
                                class="reset-btn"
                                @click=${() => {
      this.setTheme(""), this.requestUpdate();
                    ...
                    <div class="option-row">
                      <ul>
                        ${this._themesForCurrentAnimation.map((i) => Ut`
                            <li>
                              <button
                                class="option-button"
                                aria-label="${i.id}"
      ...
      this.exitInteractiveMode(), this.requestUpdate();
                    ...
                    <div class="option-row">
                      <ul>
                        ${this._statesForCurrentAnimation.map((i) => Ut`
                            <li>
                              <button
                                class="option-button"
                                aria-label="${i}"
      ...
      (o.code === "Space" || o.code === "Enter") && this.enterInteractiveMode(i);
                              ...
                              >
                                <div class="option-tick">
                                  ${this.getActiveStateMachine() === i ? Ut`
                                        <svg
                                          width="24"
                                          height="24"
                                          viewBox="0 0 24 24"
    ...
    return Ut`
      <div id="animation-container" class=${t} lang="en" role="img" aria-label="lottie-animation-container">
        <div id="animation" class=${e} style="background:${this.background};">
          ${((_a = this._dotLottieCommonPlayer) == null ? void 0 : _a.currentState) === Zi.Error ? Ut` <div class="error">⚠️</div> ` : void 0}
        </div>
...
j([l({ type: String })], r.prototype, "defaultTheme", 2), j([w2("#animation")], r.prototype, "container", 2), j([l()], r.prototype, "playMode", 2), j([l({ type: Boolean })], r.prototype, "autoplay", 2), j([l({ type: String })], r.prototype, "background", 2), j([l({ type: Boolean })], r.prototype, "controls", 2), j([l({ type: Number })], r.prototype, "direction", 2), j([l({ type: Boolean })], r.prototype, "hover", 2), j([l({ type: String })], r.prototype, "loop", 2), j([l({ type: String })], r.prototype, "renderer", 2), j([l({ type: Number })], r.prototype, "speed", 2), j([l({ type: String })], r.prototype, "src", 2), j([l()], r.prototype, "intermission", 2), j([l({ type: String })], r.prototype, "activeAnimationId", 2), j([l({ type: Boolean })], r.prototype, "light", 2), j([l({ type: Boolean })], r.prototype, "worker", 2), j([l({ type: String })], r.prototype, "activeStateId", 2), j([L2()], r.prototype, "_seeker", 2);
customElements.get(k2) || customElements.define(k2, r);
export {
  r as DotLottiePlayer,
  tn as PlayMode
};
/*! Bundled license information:

@dotlottie/player-component/dist/chunk-6BVPVBJE.mjs:
  (*! Bundled license information:
